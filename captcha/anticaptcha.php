...
class Anticaptcha {
    ...
    public function createTask() {
        ...
        if ($submitResult->errorId == 0) {
            ...
            if ($submitResult->errorCode == "ERROR_NO_SLOT_AVAILABLE") {

                echo "ERROR_NO_SLOT_AVAILABLE. Trying again create task..\n";
                sleep(15);
    ...
    public function jsonPostRequest($methodName, $postData) {
        ...
        if ($this->verboseMode) {
            echo "anticaptcha: making request to {$this->scheme}://{$this->host}/$methodName\n";
            //print_r($postData);
        }
